...
<!-- component -->
<div class="py-16 bg-white-200">  
    <div class="container m-auto px-6 text-gray-500 md:px-12 xl:px-0">
        <div class="mx-auto grid gap-6 md:w-3/4 lg:w-full lg:grid-cols-3">
            <div class="bg-white rounded-2xl shadow-xl px-8 py-12 sm:px-12 lg:px-8">
                <div class="mb-12 space-y-4">
                    <h3 class="text-2xl font-semibold text-blue-800">Network Penetration Testing</h3>
                    <p class="mb-6">Els nostres especialistes en seguretat de xarxa avaluen àmpliament les possibles vulnerabilitats per identificar possibles intrusions i amenaces de programari maliciós.</p>
                    <a href="#" class="block font-medium text-blue-600">Saber més</a>
                </div>
                <img src="https://redteamlabs.in/media/2021/10/Network-Penetration-Testing-min.jpg" class="w-3/3 mx-auto mb-12" alt="illustration" loading="lazy" width="900" height="600">
            </div>
            <div class="bg-white rounded-2xl shadow-xl px-8 py-12 sm:px-12 lg:px-8">
                <div class="mb-12 space-y-4">
                    <h3 class="text-2xl font-semibold text-blue-800">Cloud Penetration Testing</h3>
                    <p class="mb-6">Obteniu protecció a les aplicacions i dades al núvol amb les metodologies més provades del sector i els serveis de seguretat SaaS, Pass i IaaS.</p>
                    <a href="#" class="block font-medium text-blue-600">Saber més</a>
                </div>
                <img src="https://redteamlabs.in/media/2021/10/Cloud-Penetration-Testing-min.jpg" class="w-3/3 mx-auto" alt="illustration" loading="lazy" width="900" height="600">
            </div>
            <div class="bg-white rounded-2xl shadow-xl px-8 py-12 sm:px-12 lg:px-8">
                <div class="mb-12 space-y-4">
                    <h3 class="text-2xl font-semibold text-blue-800">Revisió del codi font</h3>
                    <p class="mb-6">Maximitzeu la vostra seguretat. Et validarem el codi font de les vostres aplicacions pels nostres experts en ciberseguretat.</p>
                    <a href="#" class="block font-medium text-blue-600">Saber més</a>
                </div>
                <img src="https://redteamlabs.in/media/2021/10/Source-Code-Review-Service-min.jpg" class="w-3/3 mx-auto " alt="illustration" loading="lazy" width="900" height="600">
            </div>
...
Avaluacions de seguretat d'aplicacions</h3>
                    <p class="mb-6">Assegurem les vostres aplicacions web, mòbils i al núvol amb proves exhaustives de penetració d'aplicacions i serveis d'avaluació de seguretat.</p>
                    <a href="#" class="block font-medium text-blue-600">Saber més</a>
                </div>
                <img src="https://redteamlabs.in/media/2021/10/Application-Security-Assessments-min.jpg" class="w-3/3 mx-auto -mb-12" alt="illustration" loading="lazy" width="900" height="600">
            </div>
            <div class="bg-white rounded-2xl shadow-xl px-8 py-12 sm:px-12 lg:px-8">
                <div class="mb-12 space-y-4">
                    <h3 class="text-2xl font-semibold text-blue-800">Desenvolupament de programes</h3>
                    <p class="mb-6">Potenciem els teus programes amb un desenvolupament segur. Mantingueu-vos al capdavant d'aplicacions segures i llestes per al mercat.</p>
                    <a href="#" class="block font-medium text-blue-600">Saber més</a>
                </div>
                <img src="https://redteamlabs.in/media/2021/10/Product-Development-Program-min.jpg" class="w-3/3 mx-auto" alt="illustration" loading="lazy" width="900" height="600">
            </div>
            <div class="bg-white rounded-2xl shadow-xl px-8 py-12 sm:px-12 lg:px-8">
                <div class="mb-12 space-y-4">
                    <h3 class="text-2xl font-semibold text-blue-800">Assessorament</h3>
                    <p class="mb-6">Avaluem les vostres solucions de seguretat amb processos de redteaming rigorosos amb una gran simulació d'adversari.</p>
                    <a href="#" class="block font-medium text-blue-600">Saber més</a>
                </div>
                <img src="https://redteamlabs.in/media/2021/10/Assessments-min.jpg" class="w-3/3 mx-auto " alt="illustration" loading="lazy" width="900" height="600">
            </div>

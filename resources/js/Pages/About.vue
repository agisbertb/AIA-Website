  ...
  <div class="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
      <div class="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
        <div class="md:5/12 lg:w-5/12">
          <img src="https://redteamacademy.ae/wp-content/uploads/2022/09/1-2.jpg" alt="image" loading="lazy" width="" height="">
        </div>
        <div class="md:7/12 lg:w-6/12">
          <h2 class="text-2xl text-gray-900 font-bold md:text-4xl">Sobre nosaltres</h2>
          <br>
          <p class="mt-1 text-gray-600">Som una empresa que ens dediquem a protegir a altres empreses i usuaris dels riscs i amenaces en línia. Això inclou la implementació de mesures de seguretat tecnològiques com tallafocs, xifrat, autenticació d'usuaris i monitoratge de la xarxa per detectar i prevenir atacs. També brindem assessorament i capacitació per a enfortir la seguretat de l'organització i serveis de raspallament davant incidències de seguretat. La ciberseguretat és crucial en l'era digital actual per garantir la privacitat i protecció de la informació en línia.</p>
        </div>
      </div>
  </div>
</div>
